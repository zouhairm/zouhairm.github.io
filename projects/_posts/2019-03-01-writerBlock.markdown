...
title: Visualizing Traveler's stories with Doc2Vec and WebGL graph renderer
venue: SriLanka, 2019
description: |
...
#### Overcoming Fears
Weather it's fears of traveling alone, flying, sky-diving, jumping off-boats ... This is one of the biggest constellations, and is self-explanatory. Here is a small sample:
...
This cluster of stories describes the challenges that arise due a clash of Nationality, identity, and/or religion
...
Some other clusters that I found interesting:
